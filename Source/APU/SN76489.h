...
{
public:
	CSN76489Channel(CMixer &Mixer, std::uint8_t nInstance, sn76489_subindex_t subindex);		// // //
...
{
public:
	CSNSquare(CMixer &Mixer, std::uint8_t nInstance, sn76489_subindex_t subindex);
	~CSNSquare();
...
{
public:
	CSNNoise(CMixer &Mixer, std::uint8_t nInstance);
	~CSNNoise();
...
{
public:
	CSN76489(CMixer &Mixer, std::uint8_t nInstance);
...
//	void	SetVGMWriter(const CVGMWriterBase *pWrite);
	...
	static const uint16_t LATCH_PORT;
